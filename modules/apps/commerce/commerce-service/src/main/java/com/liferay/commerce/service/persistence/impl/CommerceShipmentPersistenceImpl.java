...
public class CommerceShipmentPersistenceImpl
	...
	protected CommerceShipment filterGetByGroupId_PrevAndNext(
		Session session, CommerceShipment commerceShipment, long groupId,
		OrderByComparator<CommerceShipment> orderByComparator,
		boolean previous) {
		...
		List<CommerceShipment> list = sqlQuery.list();
	...
	public CommerceShipment[] filterFindByG_C_PrevAndNext(
		...
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByG_C_PrevAndNext(
				commerceShipmentId, groupId, commerceAddressId,
				orderByComparator);
		}
	...
	protected CommerceShipment filterGetByG_C_PrevAndNext(
		Session session, CommerceShipment commerceShipment, long groupId,
		long commerceAddressId,
		OrderByComparator<CommerceShipment> orderByComparator,
		boolean previous) {
	...
	protected CommerceShipment filterGetByG_S_PrevAndNext(
		Session session, CommerceShipment commerceShipment, long groupId,
		int status, OrderByComparator<CommerceShipment> orderByComparator,
		boolean previous) {
