...
public abstract class BaseWarehouseAccountGroupResourceImpl
	...
	@jakarta.ws.rs.Path("/warehouse-account-groups/{warehouseAccountGroupId}")
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public void deleteWarehouseAccountGroup(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@jakarta.validation.constraints.NotNull
			@jakarta.ws.rs.PathParam("warehouseAccountGroupId")
	...
	@jakarta.ws.rs.DELETE
	@jakarta.ws.rs.Path("/warehouse-account-groups/batch")
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/warehouses/{id}/warehouse-account-groups")
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	...
	@jakarta.ws.rs.Consumes("application/json")
	@jakarta.ws.rs.Path("/warehouses/warehouse-account-groups/batch")
	@jakarta.ws.rs.POST
	@jakarta.ws.rs.Produces("application/json")
	@Override
