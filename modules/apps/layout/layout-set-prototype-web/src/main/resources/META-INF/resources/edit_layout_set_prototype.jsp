...
String layoutsUpdateableHelpMessage = FeatureFlagManagerUtil.isEnabled("LPD-82107") ? "allow-site-administrators-to-modify-pages-associated-with-this-site-template-sync-help" : "allow-site-administrators-to-modify-pages-associated-with-this-site-template-help";
