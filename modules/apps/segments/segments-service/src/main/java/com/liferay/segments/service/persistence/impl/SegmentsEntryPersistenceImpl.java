...
public class SegmentsEntryPersistenceImpl
	...
	public SegmentsEntry findByG_A_SRC_Last(
		...
		SegmentsEntry segmentsEntry = fetchByG_A_SRC_Last(
			groupId, active, source, orderByComparator);
	...
	public SegmentsEntry fetchByG_A_SRC_Last(
		...
		int count = countByG_A_SRC(groupId, active, source);
		...
		List<SegmentsEntry> list = findByG_A_SRC(
			groupId, active, source, count - 1, count, orderByComparator);
	...
	public SegmentsEntry[] findByG_A_SRC_PrevAndNext(
		...
		try {
			...
			array[0] = getByG_A_SRC_PrevAndNext(
				session, segmentsEntry, groupId, active, source,
				orderByComparator, true);

			array[1] = segmentsEntry;

			array[2] = getByG_A_SRC_PrevAndNext(
				session, segmentsEntry, groupId, active, source,
	...
	protected SegmentsEntry getByG_A_SRC_PrevAndNext(
		Session session, SegmentsEntry segmentsEntry, long groupId,
	...
	public SegmentsEntry[] filterFindByG_A_SRC_PrevAndNext(
		...
		if (!InlineSQLHelperUtil.isEnabled(groupId)) {
			return findByG_A_SRC_PrevAndNext(
				segmentsEntryId, groupId, active, source, orderByComparator);
		}
		...
		try {
			...
			array[0] = filterGetByG_A_SRC_PrevAndNext(
				session, segmentsEntry, groupId, active, source,
				orderByComparator, true);

			array[1] = segmentsEntry;

			array[2] = filterGetByG_A_SRC_PrevAndNext(
				session, segmentsEntry, groupId, active, source,
				orderByComparator, false);
	...
	protected SegmentsEntry filterGetByG_A_SRC_PrevAndNext(
		Session session, SegmentsEntry segmentsEntry, long groupId,
		boolean active, String source,
		OrderByComparator<SegmentsEntry> orderByComparator, boolean previous) {
