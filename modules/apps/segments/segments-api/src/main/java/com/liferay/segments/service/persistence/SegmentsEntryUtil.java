...
public class SegmentsEntryUtil {
	 ...
	 * @throws NoSuchEntryException if a matching segments entry could not be found
	 */
	public static SegmentsEntry findByG_A_SRC_Last(
			long groupId, boolean active, String source,
			OrderByComparator<SegmentsEntry> orderByComparator)
		throws com.liferay.segments.exception.NoSuchEntryException {

		return getPersistence().findByG_A_SRC_Last(
			groupId, active, source, orderByComparator);
	}
	 ...
	 * @return the last matching segments entry, or <code>null</code> if a matching segments entry could not be found
	 */
	public static SegmentsEntry fetchByG_A_SRC_Last(
		long groupId, boolean active, String source,
		OrderByComparator<SegmentsEntry> orderByComparator) {

		return getPersistence().fetchByG_A_SRC_Last(
			groupId, active, source, orderByComparator);
	}
	 ...
	 * @throws NoSuchEntryException if a segments entry with the primary key could not be found
	 */
	public static SegmentsEntry[] findByG_A_SRC_PrevAndNext(
			long segmentsEntryId, long groupId, boolean active, String source,
			OrderByComparator<SegmentsEntry> orderByComparator)
		throws com.liferay.segments.exception.NoSuchEntryException {

		return getPersistence().findByG_A_SRC_PrevAndNext(
	 ...
	 * @throws NoSuchEntryException if a segments entry with the primary key could not be found
	 */
	public static SegmentsEntry[] filterFindByG_A_SRC_PrevAndNext(
			long segmentsEntryId, long groupId, boolean active, String source,
			OrderByComparator<SegmentsEntry> orderByComparator)
		throws com.liferay.segments.exception.NoSuchEntryException {

		return getPersistence().filterFindByG_A_SRC_PrevAndNext(
			segmentsEntryId, groupId, active, source, orderByComparator);
	}
