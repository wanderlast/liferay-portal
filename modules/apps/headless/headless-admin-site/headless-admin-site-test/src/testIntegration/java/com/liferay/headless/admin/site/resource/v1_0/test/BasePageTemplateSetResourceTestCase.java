...
public abstract class BasePageTemplateSetResourceTestCase {
	...
	@Test
	public void testGraphQLDeleteSitePageTemplateSet() throws Exception {

		// No namespace

		PageTemplateSet pageTemplateSet1 =
			testGraphQLDeleteSitePageTemplateSet_addPageTemplateSet();

		Assert.assertTrue(
			JSONUtil.getValueAsBoolean(
				invokeGraphQLMutation(
					new GraphQLField(
						"deletePageTemplateSet",
				...
				"JSONObject/data", "Object/deletePageTemplateSet"));
		...
		JSONArray errorsJSONArray1 = JSONUtil.getValueAsJSONArray(
			invokeGraphQLQuery(
				new GraphQLField(
					...
					new GraphQLField("pageTemplateSetId"))),
			"JSONArray/errors");
	...
	public void testGraphQLGetSitePageTemplateSet() throws Exception {
		PageTemplateSet pageTemplateSet =
			testGraphQLGetSitePageTemplateSet_addPageTemplateSet();
					...
					JSONUtil.getValueAsString(
						invokeGraphQLQuery(
							new GraphQLField(
								...
								new HashMap<String, Object>() {
									{
										put(
											...
											"\"" +
												testGraphQLGetSitePageTemplateSet_getSiteExternalReferenceCode() +
													"\"");
										put(
											"pageTemplateSetExternalReferenceCode",
											"\"" +
								...
								getGraphQLFields())),
						"JSONObject/data", "Object/pageTemplateSet"))));
	...
	@Test
	public void testGraphQLGetSitePageTemplateSetNotFound() throws Exception {
	...
	public void testGraphQLGetSitePageTemplateSetsPage() throws Exception {
		...
		JSONObject pageTemplateSetsJSONObject = JSONUtil.getValueAsJSONObject(
			invokeGraphQLQuery(graphQLField), "JSONObject/data",
			"JSONObject/pageTemplateSets");

		long totalCount = pageTemplateSetsJSONObject.getLong("totalCount");

		PageTemplateSet pageTemplateSet1 =
			testGraphQLGetSitePageTemplateSetsPage_addPageTemplateSet();
		PageTemplateSet pageTemplateSet2 =
			testGraphQLGetSitePageTemplateSetsPage_addPageTemplateSet();

		pageTemplateSetsJSONObject = JSONUtil.getValueAsJSONObject(
			invokeGraphQLQuery(graphQLField), "JSONObject/data",
			"JSONObject/pageTemplateSets");

		Assert.assertEquals(
			totalCount + 2, pageTemplateSetsJSONObject.getLong("totalCount"));

		assertContains(
			pageTemplateSet1,
			Arrays.asList(
				PageTemplateSetSerDes.toDTOs(
					pageTemplateSetsJSONObject.getString("items"))));
		assertContains(
			pageTemplateSet2,
			Arrays.asList(
				PageTemplateSetSerDes.toDTOs(
	...
	@Test
	public void testGraphQLPostSitePageTemplateSet() throws Exception {
		PageTemplateSet randomPageTemplateSet = randomPageTemplateSet();

		PageTemplateSet pageTemplateSet =
			testGraphQLPageTemplateSet_addPageTemplateSet(
				randomPageTemplateSet);

		Assert.assertTrue(equals(randomPageTemplateSet, pageTemplateSet));
	}
	...
	protected PageTemplateSet testGraphQLPageTemplateSet_addPageTemplateSet(
		...
		JSONDeserializer<PageTemplateSet> jsonDeserializer =
			JSONFactoryUtil.createJSONDeserializer();

		StringBuilder sb = new StringBuilder("{");

		for (java.lang.reflect.Field field :
				getDeclaredFields(PageTemplateSet.class)) {
			...
			appendGraphQLFieldValue(sb, field.get(pageTemplateSet));
		}
		...
		return jsonDeserializer.deserialize(
			JSONUtil.getValueAsString(
				invokeGraphQLMutation(
					new GraphQLField(
						"createSitePageTemplateSet",
						new HashMap<String, Object>() {
							{
								put(
									"siteKey",
									"\"" + testGroup.getGroupId() + "\"");
								put("pageTemplateSet", sb.toString());
							}
						},
						graphQLFields)),
				"JSONObject/data", "JSONObject/createSitePageTemplateSet"),
			PageTemplateSet.class);
	}
