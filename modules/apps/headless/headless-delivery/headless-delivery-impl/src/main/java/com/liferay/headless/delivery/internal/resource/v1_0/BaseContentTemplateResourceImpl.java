...
public abstract class BaseContentTemplateResourceImpl
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/asset-libraries/{assetLibraryId}/content-templates")
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/sites/{siteId}/content-templates/{contentTemplateId}")
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/sites/{siteId}/content-templates")
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	...
	@jakarta.ws.rs.Consumes("application/json")
	@jakarta.ws.rs.Path("/sites/{siteId}/content-templates/export-batch")
	@jakarta.ws.rs.POST
	@jakarta.ws.rs.Produces("application/json")
	@Override
