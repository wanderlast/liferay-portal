...
public abstract class BaseFormStructureResourceImpl
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/form-structures/{formStructureId}")
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public FormStructure getFormStructure(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@jakarta.validation.constraints.NotNull
			@jakarta.ws.rs.PathParam("formStructureId")
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/sites/{siteId}/form-structures")
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	...
	@jakarta.ws.rs.Path("/sites/{siteId}/form-structures/export-batch")
	@jakarta.ws.rs.POST
