...
public abstract class BaseFormResourceImpl
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/forms/{formId}")
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/sites/{siteId}/forms")
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	...
	@jakarta.ws.rs.Path("/forms/{formId}/evaluate-context")
	@jakarta.ws.rs.POST
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	...
	@jakarta.ws.rs.Path("/forms/{formId}/form-document")
	@jakarta.ws.rs.POST
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	...
	@jakarta.ws.rs.Path("/sites/{siteId}/forms/export-batch")
	@jakarta.ws.rs.POST
