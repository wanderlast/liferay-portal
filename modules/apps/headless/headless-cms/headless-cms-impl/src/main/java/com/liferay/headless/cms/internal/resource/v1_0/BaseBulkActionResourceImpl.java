...
public abstract class BaseBulkActionResourceImpl
	 ...
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/headless-cms/v1.0/bulk-action' -d $'{"bulkActionItems": ___, "selectAll": ___, "type": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
