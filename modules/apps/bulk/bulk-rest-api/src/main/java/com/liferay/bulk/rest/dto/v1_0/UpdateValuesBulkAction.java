 ...
 */
@Generated("")
@GraphQLName("UpdateValuesBulkAction")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "UpdateValuesBulkAction")
public class UpdateValuesBulkAction extends BulkAction implements Serializable {

	public static UpdateValuesBulkAction toDTO(String json) {
		return ObjectMapperUtil.readValue(UpdateValuesBulkAction.class, json);
	}

	public static UpdateValuesBulkAction unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(
			UpdateValuesBulkAction.class, json);
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.bulk.rest.dto.v1_0.UpdateValuesBulkAction",
		name = "x-class-name"
	)
