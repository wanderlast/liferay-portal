...
public abstract class BaseNotificationQueueEntryResourceImpl
	...
	public void deleteNotificationQueueEntry(
			...
			@jakarta.ws.rs.PathParam("notificationQueueEntryId")
	...
	@jakarta.ws.rs.DELETE
	@jakarta.ws.rs.Path("/notification-queue-entries/batch")
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/notification-queue-entries")
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	...
	@jakarta.ws.rs.Consumes("application/json")
	@jakarta.ws.rs.Path("/notification-queue-entries/export-batch")
	@jakarta.ws.rs.POST
	@jakarta.ws.rs.Produces("application/json")
	@Override
