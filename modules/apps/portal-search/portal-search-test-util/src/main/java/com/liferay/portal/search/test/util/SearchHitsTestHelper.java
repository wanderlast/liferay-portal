 ...
 */
public class SearchHitsTestHelper {

	public SearchHitsTestHelper add(Integer index, ClassName className) {
		_classNames.put(index, className);

		return this;
	}

	public SearchHitsTestHelper add(Integer index, SearchHit searchHit) {
