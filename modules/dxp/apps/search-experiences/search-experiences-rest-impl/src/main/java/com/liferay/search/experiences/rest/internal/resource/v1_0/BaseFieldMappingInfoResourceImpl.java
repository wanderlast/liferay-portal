...
public abstract class BaseFieldMappingInfoResourceImpl
	...
	@jakarta.ws.rs.GET
	@jakarta.ws.rs.Path("/field-mapping-infos")
	@jakarta.ws.rs.Produces({"application/json", "application/xml"})
	@Override
	public Page<FieldMappingInfo> getFieldMappingInfosPage(
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@jakarta.ws.rs.QueryParam("external")
			Boolean external,
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
			@jakarta.ws.rs.QueryParam("indexName")
			String indexName,
			@io.swagger.v3.oas.annotations.Parameter(hidden = true)
	...
	@jakarta.ws.rs.Path("/field-mapping-infos/export-batch")
	@jakarta.ws.rs.POST
