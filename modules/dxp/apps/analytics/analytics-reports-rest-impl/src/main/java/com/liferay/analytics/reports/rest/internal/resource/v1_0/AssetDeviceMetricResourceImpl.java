 ...
 */
@Component(
	properties = "OSGI-INF/liferay/rest/v1_0/asset-device-metric.properties",
	scope = ServiceScope.PROTOTYPE, service = AssetDeviceMetricResource.class
)
public class AssetDeviceMetricResourceImpl
	extends BaseAssetDeviceMetricResourceImpl {
	...
	public AssetDeviceMetric getGroupAssetMetricAssetTypeDevice(
		...
		return analyticsCloudClient.getAssetDeviceMetric(
